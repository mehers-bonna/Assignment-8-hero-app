...
const AppCard = ({app}) => {
    console.log(app)
    const {image, ratingAvg, title, description, ratings} = app
    return (
        <div className="card bg-base-100 w-96 shadow hover:scale-105 transition ease-in-out">
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-between">
                    <button className="flex gap-2 bg-[#F1F5E8] px-4 py-2 rounded-sm text-[#00D390]"><img src={download2} alt="" />{ratingAvg}M</button>
